  ...
  return (
    <div className={styles.pinkBlock} id="our-services">
      ...
      <BodyText className={styles.p}>
        Akron Snowmen plows industrial, commercial, and corporate properties in
        the Akron area. We have the tools, the skills, and the willingness to
        plow, shovel, and salt your property, quickly, and keep your customers
        happy.
      </BodyText>
      <PinkGrid />
